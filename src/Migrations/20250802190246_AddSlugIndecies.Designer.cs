...
namespace cycling_project_web_api.Migrations
{
    ...
    [Migration("20250802190246_AddSlugIndecies")]
    partial class AddSlugIndecies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.EntityModels.Mountain", b =>
                {
                    ...
                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasDatabaseName("ix_mountains_slug");
            ...
            modelBuilder.Entity("App.EntityModels.MountainClimb", b =>
                {
                    ...
                    b.Property<int>("ClimbLengthMeters")
                        .HasColumnType("integer")
                        .HasColumnName("climb_length_meters");
            ...
            modelBuilder.Entity("App.EntityModels.Rider", b =>
                {
                    ...
                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasDatabaseName("ix_riders_slug");
            ...
            modelBuilder.Entity("App.EntityModels.StageCombativityAward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_stage_combativity_awards");

                    b.HasIndex("RaceRiderParticipationId")
                        .HasDatabaseName("ix_stage_combativity_awards_race_rider_participation_id");

                    b.HasIndex("StageId")
                        .HasDatabaseName("ix_stage_combativity_awards_stage_id");

                    b.ToTable("stage_combativity_awards", (string)null);
                });

            modelBuilder.Entity("App.EntityModels.StageNonFinish", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_stage_non_finishes");

                    b.HasIndex("RaceRiderParticipationId")
                        .HasDatabaseName("ix_stage_non_finishes_race_rider_participation_id");

                    b.HasIndex("StageId", "RaceRiderParticipationId")
                        .IsUnique()
                        .HasDatabaseName("ix_stage_non_finishes_stage_id_race_rider_participation_id");

                    b.ToTable("stage_non_finishes", (string)null);
                });
            ...
            modelBuilder.Entity("App.EntityModels.MountainClimbResult", b =>
                {
                    b.HasOne("App.EntityModels.MountainClimb", "MountainClimb")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_mountain_climb_results_mountain_climbs_mountain_climb_id");
            ...
            modelBuilder.Entity("App.EntityModels.StageCombativityAward", b =>
                {
                    b.HasOne("App.EntityModels.RaceRiderParticipation", "RaceRiderParticipation")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_stage_combativity_awards_race_rider_participations_race_rid");
                    ...
                    b.HasOne("App.EntityModels.Stage", "Stage")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_stage_combativity_awards_stages_stage_id");
            ...
            modelBuilder.Entity("App.EntityModels.StageNonFinish", b =>
                {
                    b.HasOne("App.EntityModels.RaceRiderParticipation", "RaceRiderParticipation")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_stage_non_finishes_race_rider_participations_race_rider_par");
                    ...
                    b.HasOne("App.EntityModels.Stage", "Stage")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_stage_non_finishes_stages_stage_id");
